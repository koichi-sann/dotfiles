...
local myawesomemenu = {
  ...
  { "edit config", "vi ~/.config/awesome/rc.lua" },
  { "arandr", "arandr" },
...
-- dmenu
  awful.key({ modkey, "Shift" }, "Return",
    function()
      awful.spawn(string.format("dmenu_run -c -l 20",
  ...
  awful.key({ altkey, "Control" }, "e",
    function() awful.util.spawn_with_shell("~/dmenu/scripts/dmenu-edit-configs.sh") end,
  ...
  -- awful.key({ modkey, altkey }, "b", function () awful.util.spawn( "surf duckduckgo.com" ) end,
  ...
  awful.key({ modkey, altkey }, "l",
    function() awful.util.spawn(terminal ..
        " -e lynx --cfg=~/.lynx/lynx.cfg --lss=~/.lynx/lynx.lss -vikeys")
    end,
